                  ...
                  {conditionWatch === "refurbished" && (
                    <div className="grid grid-cols-1 gap-4 p-4 border border-orange-500/20 bg-orange-500/5 rounded-md">
                      <FormField control={form.control} name="conditionScore" render={({ field }) => (
                        <FormItem><FormLabel>Condition Score (1-10)</FormLabel><FormControl><Input type="number" min="1" max="10" step="0.1" {...field} onChange={e => field.onChange(e.target.value ? parseFloat(e.target.value) : undefined)} /></FormControl><FormMessage /></FormItem>
                      )} />
